...
declare @ID_MENSAJE INT, @SDD_ID INT

/* PARAMETROS QUE SE DEBEN MODIFICAR PARA REALIZAR LA REPARACIÓN */

SET @ID_MENSAJE = 2462102
----------------------------------------------------------
SET @SDD_ID = (SELECT TOP 1 SDD_ID FROM Saydex_Integracion..COLA_ERROR_INTEGRACION WHERE ID_MENSAJE = @ID_MENSAJE)
